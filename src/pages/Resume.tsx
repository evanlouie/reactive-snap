...
export const Resume: React.StatelessComponent<IResume> = (
  { profile, education, experience, skills } = {
    profile:
      ...
      "+ years experience. Web developer through and through, Evan enjoys developing with bleeding edge technologies in his search for the perfect web stack. Evan is currently a open-source software engineer on Microsoft's Commercial Software Engineering team working on all things Kubernetes, Docker, and Azure.",
    experience: [
      {
    ...
    skills: [
      {
        ...
        icon: (
          <svg id="kubernetes" viewBox="0 0 722.846 701.966">
            <path
